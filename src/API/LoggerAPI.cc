...
namespace jse
{
    ...
    Local<Value> LoggerAPI::colorLog(Arguments const &args)
    {
        ...
        try
        {
            ...
            if (color == "dk_blue")
                sout << "\x1b[34m";
            else if (color == "dk_green")
                sout << "\x1b[32m";
            else if (color == "bt_blue")
                sout << "\x1b[36m";
            else if (color == "dk_red")
                sout << "\x1b[31m";
            else if (color == "purple")
                sout << "\x1b[35m";
            else if (color == "dk_yellow")
                sout << "\x1b[33m";
            else if (color == "grey")
                sout << "\x1b[37m";
        ...
        try
        {
            ...
            for (int i = offset; i < args.size(); i++)
            {
                ...
                case ValueKind::kNumber:
                    if (IsFloat(arg))
                        format_args.push_back(arg.asNumber().toDouble());
                    else
                        format_args.push_back(arg.asNumber().toInt32());
                    break;
